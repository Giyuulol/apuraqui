...
import 'comparador_proposta_page.dart'; // Importa o comparador que está na mesma pasta
  ...
  Future<void> _handleLogin() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => const ComparadorPropostasScreen(),
        ),
      );
    }
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // ── BOTÃO DE DESENVOLVIMENTO (TEMPORÁRIO) ──
                // Permite testar a tela de propostas direto do Login
                TextButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                  ...
                  label: const Text('Dev: Ver Comparador de Propostas'),
                  style: TextButton.styleFrom(
